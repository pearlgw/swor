                ...
                <form action="{{ route('pasien.update', $pasien->id) }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="metode" class="w-full rounded border-gray-300"
                            value="{{ old('metode', $pasien->metode) }}">
                    </div>

                    <div>
                        <label class="block font-medium">Diagnosa Utama</label>
                        <textarea name="diagnosa_utama" class="w-full rounded border-gray-300">{{ old('diagnosa_utama', $pasien->diagnosa_utama) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="tingkat_hemiparese" class="w-full rounded border-gray-300"
                            value="{{ old('tingkat_hemiparese', $pasien->tingkat_hemiparese) }}">
                    </div>

                    <div>
                        <label class="block font-medium">Riwayat Penyakit</label>
                        <textarea name="riwayat_penyakit" class="w-full rounded border-gray-300">{{ old('riwayat_penyakit', $pasien->riwayat_penyakit) }}</textarea>
                    </div>

                    <div>
                        <label class="block font-medium">Tanggal Sakit</label>
                        <input type="date" name="tanggal_sakit" class="w-full rounded border-gray-300"
                            value="{{ old('tanggal_sakit', $pasien->tanggal_sakit) }}">
                    </div>
