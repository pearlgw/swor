<!-- Tim -->
<section id="tim" class="py-20 px-6 md:px-20 bg-blue-50">
    <div class="max-w-7xl mx-auto text-center">
        <h2 class="text-3xl font-bold text-blue-600 mb-12">Tim Pengembang</h2>

        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            <!-- Row 1: hanya 1 orang di tengah -->
            <div class="md:col-span-1"></div> <!-- kosong kiri -->
            <div class="bg-white p-8 rounded-xl shadow-lg flex flex-col items-center">
                <img src="{{ asset('image/wisnu.jpeg') }}" alt="Anggota 7"
                    class="w-28 h-28 rounded-full object-cover mb-4 shadow" />
                <h3 class="font-semibold text-lg text-blue-700">Wisnu Adi Prasetyanto, ST, M.Eng</h3>
                <p class="text-gray-600">0686.11.2000.201</p>
                <p class="text-gray-500">Dosen Pembimbing</p>
            </div>
            <div class="md:col-span-1"></div> <!-- kosong kanan -->

            <!-- Row 2: 3 orang full -->
            <div class="bg-white p-8 rounded-xl shadow-lg flex flex-col items-center">
                <img src="{{ asset('image/rahayu.jpg') }}" alt="Rahayu Melani"
                    class="w-28 h-28 rounded-full object-cover mb-4 shadow" />
                <h3 class="font-semibold text-lg text-blue-700">Rahayu Melani</h3>
                <p class="text-gray-600">E13.2022.00237</p>
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg flex flex-col items-center">
                ...
                <p class="text-gray-600">E13.2022.00230</p>
                <p class="text-gray-500">Teknik Biomedis</p>
            </div>
            <div class="bg-white p-8 rounded-xl shadow-lg flex flex-col items-center">
                <img src="{{ asset('image/elisabeth.jpg') }}" alt="Anggota 6"
                    class="w-28 h-28 rounded-full object-cover mb-4 shadow" />
